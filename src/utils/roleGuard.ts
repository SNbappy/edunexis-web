...
export function isTeacher(role: UserRole): boolean { return role === 'Teacher' || role === 'DepartmentAdmin' || role === 'SuperAdmin' }
export function isStudent(role: UserRole): boolean { return role === 'Student' }
export function isAdmin(role: UserRole): boolean { return role === 'DepartmentAdmin' || role === 'SuperAdmin' }
...
export function getRoleBadgeColor(role: UserRole): string {
    const colors: Record<UserRole, string> = {
        ...
        DepartmentAdmin: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
