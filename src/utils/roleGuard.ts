...
export function isTeacher(role: UserRole): boolean { return role === 'Teacher' || role === 'SuperAdmin' }
export function isStudent(role: UserRole): boolean { return role === 'Student' }
export function isAdmin(role: UserRole): boolean { return role === 'SuperAdmin' }
