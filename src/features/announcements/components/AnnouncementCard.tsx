  ...
  return (
    ...
    >
      ...
      <div className={"relative space-y-4 p-5 " + (isPinned ? "pl-6" : "")}>
            ...
            <div className="flex items-center gap-2">
              ...
              {isPinned && (
                <motion.span
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="inline-flex shrink-0 items-center gap-1 rounded-full border border-teal-200 bg-teal-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-teal-700 dark:border-teal-800 dark:bg-teal-950/50 dark:text-teal-300"
                >
                  ...
                  >
                    {canPin && (
                      ...
                      >
                        {isPinned ? (
                          <>
                            <PinOff className="h-3.5 w-3.5 text-teal-700 dark:text-teal-300" />
                            Unpin
                          </>
                        ) : (
                          <>
                            <Pin className="h-3.5 w-3.5 text-teal-700 dark:text-teal-300" />
                            Pin to top
                          </>
                        )}
                      </button>
        ...
        <div className="space-y-3" style={{ paddingLeft: 52 }}>
          <div>
            <p
              className={
            ...
            {isLong && (
              <button
                ...
                className="mt-1.5 inline-flex items-center gap-1 text-[12px] font-semibold text-teal-700 transition-colors hover:text-teal-800 dark:text-teal-300 dark:hover:text-teal-200"
              >
                {expanded ? (
                  <>
          ...
          {announcement.attachmentUrl && (
            <motion.a
              ...
              className="group/attach flex items-center gap-3 rounded-xl border border-teal-200 bg-teal-50/50 p-3 transition-colors hover:border-teal-300 hover:bg-teal-50 dark:border-teal-800 dark:bg-teal-950/20 dark:hover:border-teal-700 dark:hover:bg-teal-950/30"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-teal-100 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300">
