...
export default function CreatePresentationModal({ isOpen, onClose, courseId, onSubmit, isLoading }: Props) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Schedule Presentation" size="xl">
            <form onSubmit={handleSubmit(submit)} className="space-y-4">
                <Input {...register('title')} label="Title" placeholder="e.g. Term Presentation — Project Proposal" error={errors.title?.message} />
                ...
                <div className="flex items-center gap-3">
                    ...
                    <label htmlFor="topicsAllowed" className="text-sm text-foreground cursor-pointer">
                        Students can submit their topic
                    </label>
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={3}
                        placeholder="Guidelines, topics, evaluation criteria..."
